...
namespace Convert_If_To_Action.ProceduralVersion
{
    public class ProceduralTests
    {
        ...
        public void TestRestaurantNotYetOpen()
        {
            ...
            sut.ProcessDailySales(c.GetCurrentDate(), 1000.00m);
            c.SetCurrentDateTime(DateTime.Now.Date.AddDays(1));
            sut.ProcessDailySales(c.GetCurrentDate(), 2000.00m);
            c.SetCurrentDateTime(DateTime.Now.Date.AddDays(2));
            sut.ProcessDailySales(c.GetCurrentDate(), 492.00m);
        ...
        public void TestRestaurantLeavesProbation()
        {
            ...
            sut.ProcessDailySales(c.GetCurrentDate(), 0m);
        ...
        public void TestRestaurantThatHasBeenTerminated()
        {
            ...
            c.SetCurrentDateTime(DateTime.Now.Date.AddDays(10));
            sut.ProcessDailySales(c.GetCurrentDate(), 0);
